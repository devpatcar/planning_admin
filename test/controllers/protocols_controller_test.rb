...
class ProtocolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create protocol" do
    assert_difference('Protocol.count') do
      post protocols_url, params: { protocol: { completed: @protocol.completed, facility_item_id: @protocol.facility_item_id, result_id: @protocol.result_id, template_id: @protocol.template_id } }
    end
  ...
  test "should update protocol" do
    patch protocol_url(@protocol), params: { protocol: { completed: @protocol.completed, facility_item_id: @protocol.facility_item_id, result_id: @protocol.result_id, template_id: @protocol.template_id } }
